...
export function VideoPlayer({ streamUrl, username }: VideoPlayerProps) {
  ...
  if (!streamUrl) {
    return (
      <div className="aspect-video rounded-2xl flex flex-col items-center justify-center" style={{ background: 'var(--surface-2)' }}>
  ...
  return (
    <div className="aspect-video rounded-2xl overflow-hidden" style={{ background: 'black' }}>
      <video
        ref={videoRef}
